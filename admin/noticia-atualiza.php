...
if (isset($_POST['atualizar'])) {
    ...
    /* Se o campo "imagem* estiver vazio, então significa que o usuário NÃO quer mudar a imagem. Portanto, a imagem que já existew continuará( será ,amtida)*/
    if (empty($_FILES['imagem']['name'])) {

        // Pegamos a imagem/referência que já tem e colocamosna variabel
